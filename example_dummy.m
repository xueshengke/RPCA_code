...
imageNum = 50;       % image number for each category
para.imageNum = imageNum;
para.classNum = classNum;
para.noise_ratio = 0.1;   % 0, 0.1, 0.2, 0.3

%% get image groups
[ ImageMat ] = get_images_dummy(imagePath, para);
...
%% record test results
outputFileName = fullfile(destRoot, 'dummy_parameters.txt'); 
